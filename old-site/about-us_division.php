...
<i id="scroll"></i>
        ...
        <div class="inside_tab">
            <div class="primary">
                <div class="inner">
                    <ul>
                        <li><a href="./about-us_about.php#scroll">회사개요</a></li>
                        <li><a href="./about-us_history.php#scroll">회사연혁</a></li>
                        <li class="active"><a href="./about-us_division.php#scroll">조직도</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="inner">
                ...
                <div class="body">
                    <div class="division_wrapper">
                        ...
                        <div class="division">
                            <img class="image_pc" src="images/photo/about/division.png">
                            <img class="image_mobile" src="images/photo/about/m_division.png">
                        </div>
