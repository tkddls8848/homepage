    ...
    <div id="container">
        ...
        <div class="inside_tab">
            ...
            <div class="primary">
                <div class="inner">
                    <ul>
                        <li class="active"><a href="./about-us_about.php#scroll">회사개요</a></li>
                        <li><a href="./about-us_history.php#scroll">회사연혁</a></li>
                        <li><a href="./about-us_division.php#scroll">조직도</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="body">
                    <div class="about_wrapper">
                        ...
                        <article class="headline">
                            ...
                            <h4>
                                트라이얼정보통신은 Unix Server, NT Server, 
                                Storage, LTO 등 Hardware 전반에 걸쳐 
                                컨설팅,구축, 유지보수를 주사업으로 하고 있습니다.
                            </h4>
                        </article>

                        <article class="body">
                            <div class="top">
                                <div class="img"><img src="images/photo/about/future.png"></div>
                                <div class="text">
                                    <h4>이념</h4>
                                    <p><em>
                                        트라이얼정보통신은 대고객 만족을 위해 
                                        처음부터 끝까지 함께하며 책임지는 
                                        기업이념을 모토로 설립된 회사입니다.
                                    </em></p>
                                </div>
                            ...
                            <div class="bottom">
                                <div class="img">
                                    <div class="back">
                                        <img src="images/photo/about/tech.png">
                                    </div>
                                    <div class="narrow">
                                        <img src="images/photo/about/building.png">
                                    </div>
                                </div>
                                <div class="text">
                                    <h4>신념</h4>
                                    <p><em>
                                        고객이 없으면 우리도 없다는 신념으로 
                                        임직원 모두가 한마음 한 뜻으로 
                                        뭉쳐진 회사인 트라이얼정보통신은 
                                        여러분들의 IT발전에 
                                        많은 공헌을 할 것입니다.
