            ...
            <div class="secondary">
                <div class="inner">
                    <ul>
                        ...
                        <li class="active"><a href="./product_dell_hci-server.php#scroll">HCI Server</a></li>
                        <li><a href="./product_dell_gpu-server.php#scroll">GPU Server</a></li>
                        <li><a href="./product_dell_storage.php#scroll">Storage</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="product_wrapper">
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">
                                <i></i>
                                <p>
                                    스케일 아웃을 이용한 공간 최적화 방식의 HCI 노드(All-Flash 지원)
                                </p>
                                <div>
                                    <a href="https://www.delltechnologies.com/ko-kr/converged-infrastructure/vxrail/index.htm#accordion0" target="_blank">자세히보기</a>
                                </div>
                            </div>
                            <div class="product_img">
                                <img src="images/photo/product/dell/hci/e560.png">
                            </div>
                        </div>
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">
                                <i></i>
                                <p>
                                    대규모 워크로드에 최적화된 고성능 HCI 노드(All-Flash 지원)
                                </p>
                                <div>
                                    <a href="https://www.delltechnologies.com/ko-kr/converged-infrastructure/vxrail/index.htm#accordion0" target="_blank">자세히보기</a>
                                </div>
                            ...
                            <div class="product_img">
                                <img src="images/photo/product/dell/hci/p570.png">
                            </div>
                        </div>
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">
                                <i></i>
                                <p>
                                    2D/3D 시각화와 같은 특수한 용도의 GPU 지원 노드(All-Flash 지원)
                                </p>
                                <div>
                                    <a href="https://www.delltechnologies.com/ko-kr/converged-infrastructure/vxrail/index.htm#accordion0" target="_blank">자세히보기</a>
                                </div>
                            ...
                            <div class="product_img">
                                <img src="images/photo/product/dell/hci/v570.png">
                            </div>
                        </div>
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">
                                <i></i>
                                <p>
                                    공동작업, 데이터 분석을 위한 확장된 스토리지 HCI 노드
                                </p>
                                <div>
                                    <a href="https://www.delltechnologies.com/ko-kr/converged-infrastructure/vxrail/index.htm#accordion0" target="_blank">자세히보기</a>
                                </div>
                            ...
                            <div class="product_img">
                                <img src="images/photo/product/dell/hci/s570.png">
                            </div>
                        </div>
