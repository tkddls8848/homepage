    ...
    <div id="container">
        ...
        <div class="inside_tab">
            <div class="primary">
                <div class="inner">
                    <ul>
                        ...
                        <li class="active"><a href="./product_dell_x86-server.php#scroll">Dell</a></li>
            ...
            <div class="secondary">
                <div class="inner">
                    <ul>
                        <li><a href="./product_dell_x86-server.php#scroll">X86 Server</a></li>
                        <li><a href="./product_dell_hci-server.php#scroll">HCI Server</a></li>
                        <li><a href="./product_dell_gpu-server.php#scroll">GPU Server</a></li>
                        <li class="active"><a href="./product_dell_storage.php#scroll">Storage</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="product_wrapper">
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">
                                <i></i>
                                <p>
                                    자체 최적화 SSD, HDD 또는 하이브리드 구성은 
                                    혼합 애플리케이션 환경을 위한 경제적인 고성능 솔루션을 제공합니다.
                                </p>
                                <div>
                                    <a href="https://www.dell.com/ko-kr/work/shop/povw/storage-sc5000" target="_blank">자세히보기</a>
                                </div>
                            </div>
                            <div class="product_img">
                                <img src="images/photo/product/dell/storage/sc5020.png">
                            </div>
                        </div>
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">
                                <i></i>
                                <p>
                                    유연하고 성능이 우수하며 미래에 대비하는 
                                    SC7020으로 다양한 스토리지 과제를 극복할 수 있습니다.
                                </p>
                                <div>
                                    <a href="https://www.dell.com/ko-kr/work/shop/povw/storage-sc7020" target="_blank">자세히보기</a>
                                </div>
                            </div>
                            <div class="product_img">
                                <img src="images/photo/product/dell/storage/sc7020.png">
                            </div>
                        </div>
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">
                                <i></i>
                                <p>
                                    빠르고 확장성이 뛰어난 Dell EMC SC9000으로 
                                    데이터 센터를 가속화하고 TCO를 절감할 수 있습니다.
                                </p>
                                <div>
                                    <a href="https://www.dell.com/ko-kr/work/shop/povw/storage-sc9000" target="_blank">자세히보기</a>
                                </div>
                            </div>
                            <div class="product_img">
                                <img src="images/photo/product/dell/storage/sc9000.png">
                            </div>
                        </div>
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">
                                <i></i>
                                <p>
                                    최신 워크로드에 대한 스마트한 AFA 선택은 자체 최적화 성능, 
                                    페더레이션된 확장 및 이동성, 포괄적 소프트웨어 가치를 제공합니다.
                                </p>
                                <div>
                                    <a href="https://www.dell.com/ko-kr/work/shop/povw/storage-sc-all-flash" target="_blank">자세히보기</a>
                                </div>
                            </div>
                            <div class="product_img">
                                <img src="images/photo/product/dell/storage/all.png">
                            </div>
                        </div>
