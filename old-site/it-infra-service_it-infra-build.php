            ...
            <div class="primary">
                <div class="inner">
                    <ul>
                        ...
                        <li class="active"><a href="./it-infra-service_it-infra-build.php#scroll">IT Infra 구축</a></li>
                        <li><a href="./it-infra-service_maintenance.php#scroll">유지보수</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="body">
                    <div class="infra_wrapper">
                        ...
                        <article class="graph_wrapper">
                            <div class="graph">
                                <img src="images/photo/infra/graph_build.png">
                            </div>
                            <dl class="right top">
                                <dt>
                                    <h5><strong>
                        ...
                        <div class="comment_title">
                            <h3>
                                정보인프라 구성의 핵심요소인 서버, 스토리지, 네트워크 및 
                                가상화 관련 기술에 대한 오랜 경험과 지식을 기반으로 
                                고객 Needs를 반영한 업무 시스템 구축 서비스를 제공합니다.
                            </h3>
                            <i></i>
                        </div>
