...
<i id="scroll"></i>
        ...
        <div class="inside_tab">
            <div class="primary">
                <div class="inner">
                    <ul>
                        <li><a href="./it-infra-service_consulting.php#scroll">Consulting</a></li>
                        <li><a href="./it-infra-service_it-infra-build.php#scroll">IT Infra 구축</a></li>
                        <li class="active"><a href="./it-infra-service_maintenance.php#scroll">유지보수</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="inner">
                ...
                <div class="body">
                    <div class="infra_wrapper">
                        ...
                        <article class="graph_wrapper">
                            <div class="graph">
                                <img src="images/photo/infra/graph_maintenance.png">
                            </div>
                            <dl class="right top">
                                <dt>
                                    <h5><strong>
                        ...
                        <div class="comment_title">
                            <h3>
                                안정적인 시스템 운영을 위해 사전 예방 점검부터 장애처리까지 
                                체계적인 기술지원을 전문 인력을 통하여 제공해드립니다.
                            </h3>
                            <i></i>
                        </div>
