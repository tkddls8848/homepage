...
<body>
    ...
    <script src="js/bg.js"></script>    <!-- <header>
        <div class="inner">
            <h1><a></a></h1>
            <nav>
                <ul>
        ...
        <section class="main_slide">
            <div class="slider">
                ...
                <div class="slide_window">
                    <div class="slide_track" style="left: 0px;">
            ...
            <div class="primary">
                <div class="inner">
                    <ul>
                        ...
                        <li class="active"><a href="./product_lenovo_x86-server.php#scroll">Lenovo</a></li>
                        <li><a href="./product_dell_x86-server.php#scroll">Dell</a></li>
                        <li><a href="./product_sw_ibm-spectrum-scale.php#scroll">S/W</a></li>
                    </ul>
                </div>
            </div>
            <div class="secondary">
                <div class="inner">
                    <ul>
                        <li class="active"><a href="./product_lenovo_x86-server.php#scroll">X86 Server</a></li>
                        <li><a href="./product_lenovo_hci-server.php#scroll">HCI Server</a></li>
                        <li><a href="./product_lenovo_gpu-server.php#scroll">GPU Server</a></li>
                        <li><a href="./product_lenovo_storage.php#scroll">Storage</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="product_wrapper">
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">
                                ...
                                <div>
                                    <a href="https://www.lenovo.com/kr/ko/data-center/servers/racks/ThinkSystem-SR250/p/77XX7SRSR25" target="_blank">자세히보기</a>
                                </div>
                            </div>
                            <div class="product_img">
                                <img src="images/photo/product/lenovo/x86/sr250.png">
                            </div>
                        </div>
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">
                                <i></i>
                                <p>
                                    최고의 안정성을 통해 속도와 확장성을 제공
                                    하도록 설계 된 2소켓 랙 서버
                                </p>
                                <div>
                                    <a href="https://www.lenovo.com/kr/ko/data-center/servers/racks/ThinkSystem-SR650/p/77XX7SRSR65" target="_blank">자세히보기</a>
                                </div>
                            </div>
                            <div class="product_img">
                                <img src="images/photo/product/lenovo/x86/sr650.png">
                            </div>
                        </div>
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">
                                <i></i>
                                <p>
                                    2U 랙 형 서버에 2~4소켓 CPU 장착
                                </p>
                                <div>
                                    <a href="https://www.lenovo.com/kr/ko/data-center/servers/mission-critical/ThinkSystem-SR850/p/77XX7HSSR85" target="_blank">자세히보기</a>
                                </div>
                            </div>
                            <div class="product_img">
                                <img src="images/photo/product/lenovo/x86/sr850.png">
                            </div>
                        </div>
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">
                                <i></i>
                                <p>
                                    대용량 메모리 및 뛰어난 확장성 보유 시스템으로 최고의 
                                    컴퓨팅 성능을 제공하는 8소켓 랙 서버
                                </p>
                                <div>
                                    <a href="https://www.lenovo.com/kr/ko/data-center/servers/mission-critical/Lenovo-ThinkSystem-SR950/p/77XX7HSSR95" target="_blank">자세히보기</a>
                                </div>
                            </div>
                            <div class="product_img">
                                <img src="images/photo/product/lenovo/x86/sr950.png">
                            </div>
                        </div>
